...
% Last Modified by GUIDE v2.5 30-Jul-2020 21:33:33
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%dislay surf plot of the current selected data
surf(handles.current_data);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%display mesh plot of the current selected data
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%display contour plot of the current selected data
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%determine the selected data types
str = get(hObject,'string');
val = get(hObject,'value');
%set current data to the selected data fields
switch str{val};
    case 'peaks'
